...
function Input({
  ...
  const inputClassName = cn(
    "h-9 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] text-sm leading-9 outline-none placeholder:text-muted-foreground/72 [transition:background-color_5000000s_ease-in-out_0s]",
    size === "sm" && "h-8 px-[calc(--spacing(2.5)-1px)] leading-8",
    size === "lg" && "h-10 leading-10",
    props.type === "search" &&
