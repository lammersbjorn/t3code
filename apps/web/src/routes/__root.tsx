...
function RootRouteErrorView({ error, reset }: ErrorComponentProps) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-10 text-foreground sm:px-6">
      <section className="w-full max-w-xl rounded-xl border border-border bg-card p-6 sm:p-8">
        <p className="text-xs font-medium text-muted-foreground">{APP_DISPLAY_NAME}</p>
        ...
        <details className="group mt-5 overflow-hidden rounded-lg border border-border bg-background">
          ...
          <pre className="max-h-56 overflow-auto border-t border-border px-3 py-2 text-xs text-foreground/85">
            {details}
          </pre>
        </details>
      </section>
